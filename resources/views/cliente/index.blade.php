...
<html lang="pt-br" data-bs-theme="auto">
  <head><script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <title>Painel de Controle MaykonSilveira.com.br - Bootstrap v5.3</title>
...
<header class="navbar sticky-top bg-primary flex-md-nowrap p-0 shadow" data-bs-theme="dark" style="background:#5a23c8!important;">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">MSFLIX</a>
